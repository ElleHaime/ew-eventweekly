		...
		<section id="content" class="container page page-event col-2">
			...
			<div class="page-event__wrapper">
				...
				<div class="layout__right page-event__layout-right pure-u-5-8">
					...
					{% if eventPreviewPoster is defined or eventPreviewPosterReal is defined or eventPreviewFlyer is defined or eventPreviewFlyerReal is defined %}
						...
						<div class="b-gallery">
							...
							{% if eventPreviewPoster is defined or eventPreviewPosterReal is defined %}
								<div class="js-b-gallery-slider">
									...
									{% elseif eventPreviewPosterReal is defined %}
										<div class="b-gallery__item js-b-gallery-slider-slide">
							...
							{% endif %}		
							{% if eventPreviewFlyer is defined or eventPreviewFlyerReal is defined %}
								<div class="js-b-gallery-slider">
									{% if eventPreviewFlyer is defined %}
										<div class="b-gallery__item js-b-gallery-slider-slide">
											<img src="/upload/img/event/tmp/{{ previewFlyer }}" alt="{{ event.name }}">
										</div>
									{% elseif eventPreviewFlyerReal is defined %}
										<div class="b-gallery__item js-b-gallery-slider-slide">

...
class Event extends \Engine\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo("campaign_id", "Frontend\Models\Search\Model\Campaign", "id", ['alias' => 'Campaign']);
        $this->belongsTo("venue_id", "Frontend\Models\Search\Model\Venue", "id", ['alias' => 'Venue']);
        $this->belongsTo("id", "Frontend\Models\Search\Model\EventCategory", "event_id", ['alias' => 'Category']);
        $this->belongsTo("id", "Frontend\Models\Search\Model\EventTag", "event_id", ['alias' => 'Tag']);
    }

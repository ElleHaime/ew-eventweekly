    ...
    $.noty.themes.ew = {
        ...
        style: function() {
            ...
            this.$closeButton.css({
                ...
                top: 20, right: 20,
                width: 14, height: 14,
                background: "url(/img/glyphicons-halflings.png) -312px 0 no-repeat",
        ...
        callback: {
            onShow: function() { $.noty.themes.ew.helpers.borderFix.apply(this); },
            onClose: function() { $.noty.themes.ew.helpers.borderFix.apply(this); }
        }
    };
